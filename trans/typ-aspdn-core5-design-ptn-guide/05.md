...
![](image/B11369_05_Table_5.1.jpg)

## 响应状态码

HTTP 状态码是将发生的事情传输回 web API 消费者的方式。下表说明了在探索状态代码的预定义组之前最常见的组：

![](image/B11369_05_Table_5.2.jpg)
...
![Figure 5.1 – Workflow of a web API ](image/Figure_5.1_B11369.jpg)
...
![Figure 5.4 – Dependencies between assemblies; sharing the contracts ](image/Figure_5.4_B11369.jpg)
...
![Figure 5.5 – Visual Studio Solution Explorer exposing dependencies between projects ](image/Figure_5.5_B11369.jpg)
...
![Figure 5.6 – All clients displayed in the console as JSON ](image/Figure_5.6_B11369.jpg)
...
![Figure 5.7 – Multiple projects using the API Client to communicate with the API ](image/Figure_5.7_B11369.jpg)
