...
![](assets/2e8ca664-9540-44f8-a5d7-bba554c65015.png)
...
![](assets/f5048f51-bff3-4189-b61b-5404ac359129.png)

2.  Visual Studio 将自动添加名为`Migrations`的新文件夹。它将包含两个自动生成的文件，这些文件将帮助您在将来管理和升级数据库架构：

![](assets/0ac33a2c-e31a-450c-bf38-87b129c9cc54.png)
...
![](assets/63e362d0-5520-4959-8ae5-b315746b09e9.png)

2.  然后，转到 SQL Server 对象资源管理器，分析 Entity Framework 3 迁移在 SQL Server 中自动生成的数据库架构：

![](assets/0fb5d138-aa68-42a2-a3cc-4b76fd5a01bd.png)

3.  之后，右键单击`__EFMigrationsHistory`表并选择查看数据，查看实体框架迁移如何跟踪数据库架构版本：

![](assets/d61bc2e8-72de-49ec-a7bb-8ec53dea9690.png)
...
![](assets/8200f592-04f1-417e-b3ef-54c543ccbc61.png)
