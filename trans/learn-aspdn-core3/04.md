# 通过自定义应用程序实现 ASP.NET Core 3 的基本概念：第 1 部分
...
![](assets/be6dd680-1bf2-4376-946d-a2aab9ea50d4.png)
...
![](assets/2c88cd6c-8662-40ef-91fe-755209e4fafe.png)
...
![](assets/a2a832f2-7c94-4fc5-88d2-9be89df90e6f.png)
...
![](assets/496e7383-6a7c-4b3b-a42b-95af2c8d8701.png)
...
![](assets/3e6a0f37-1a7d-4a57-b457-1e2390e00c8c.png)

4.  将生成一个新的空 ASP.NET Core 3 web 应用程序项目，其中仅包含`Program.cs`和`Startup.cs`文件：

![](assets/646a6470-fdbd-417d-84cd-131fb10c594c.png)
...
![](assets/72ba821f-5924-4a9a-9a49-b112a530944d.png)

如果您更改`.csproj`文件并添加其他目标框架，您将看到将生成其他文件夹。然后将每个特定.NET Framework 版本的 DLL 放入相应的文件夹中：

![](assets/f374beca-401d-4bdd-a4f4-79a266342c37.png)
...
![](assets/5020f831-533a-4bba-ac59-56b54d6e465f.png)
...
对于您将要构建的每个 ASP.NET Core 3 应用程序，无论模板是 MVC 还是空模板，都会有最小的类管道，用于确保您有一个正常工作的应用程序。要启动 ASP.NET Core 3 应用程序，有两个非常重要的主要类：`Program`类和`Startup`类；以下部分将对这两个方面进行解释。
...
![](assets/2160bc27-e002-40a9-a843-d8b605eeb6b4.png)
...
![](assets/f2b1e9ae-f3af-478a-b858-8dd874f3c59e.png)
...
![](assets/9af05f8b-a346-435a-a802-997aae293034.png)

3.  在添加脚手架弹出窗口中，选择 MVC 控制器-空，并将新控制器命名为`HomeController`：

![](assets/912dd82c-8231-4e0a-9d10-0af89da85c28.png)

4.  MVC 主控制器自动生成，包含一个方法。您现在需要通过右键单击`Index`方法名称并选择添加视图来添加相应的视图。。。从菜单中：

![](assets/461476a3-e8e0-4090-9cee-75f9e31f04e8.png)

5.  “添加视图”窗口有助于定义需要生成的内容。保留默认的空模板，并启用我们将在本章下一节中修改的布局页面：

![](assets/1ae4393c-f2f5-4d4b-b244-0b946cdc9ecd.png)
...
![](assets/ac6838a7-d0f1-432a-b55c-d81b04d869f6.png)
...
![](assets/8aca3068-ecb3-482c-8016-7304c9537e4e.png)

4.  然后将客户端软件包（`bootstrap`、`jquery`等）下载到您定义的文件夹中，默认情况下，该文件夹将为（`wwwroot/lib`。现在可以在应用程序中使用静态内容：

![](assets/d61d2695-1e78-4682-af7c-1439b8db5c9e.png)
...
它们可用于为 web 应用程序中的视图定义模板。所有视图都可以使用相同的模板，也可以使用不同的模板，具体取决于您的具体需要。
...
![](assets/15dc3a1b-c016-4b9f-91fc-1982746b72e2.png)
...
![](assets/7d260c13-ee0f-46ae-9798-132aca36ed83.png)
...
![](assets/9d412054-49a5-4ddc-b9c4-df8d43aac9b8.png)
...
![](assets/9bc65926-f11b-4f84-912b-742ee936a5f0.png)

4.  将所有默认值保留在弹出窗口中，然后单击“确定”：

![](assets/be57e81c-b250-40b2-bf92-520ce628b68f.png)
...
![](assets/7843db51-c1df-47dc-b408-b95873c2ed5b.png)

使用中间件可以使您的应用程序更加灵活和进化，因为您可以在`Startup`类的`Configure`方法中轻松添加和删除中间件。
...
![](assets/b7ea6836-3a02-4dcf-9bfb-0f526699cedf.png)
...
![](assets/5eb9ee72-d532-407b-9332-e100b5fcae75.png)
...
![](assets/44d89689-99ed-44bf-af75-9070975cca5d.png)
...
![](assets/65f9769f-bd6a-4957-8178-a2e3ebb30db9.png)
...
![](assets/a3351084-84c7-425a-a18b-7757db43cef7.png)
...
![](assets/6c69d317-9022-45fe-b18f-2171f657b596.png)
...
![](assets/6a33c602-2bf5-4584-b777-b1de85b74549.png)
