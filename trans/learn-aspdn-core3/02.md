...
![](assets/01ade28d-5ffa-425d-844e-b14298477a28.png)

Visual Studio 2019 的**代码重构**和**实时代码分析**功能加快了开发速度，并确保您拥有可读和可维护的代码。例如，以下是一个实例，您可以在其中自动添加缺少的名称空间或删除不必要的名称空间：

![](assets/cc9b091b-3faa-455f-8e66-4b6d17c380e3.png)

下面是代码重构建议的一个示例，在本例中它显示为一个灯泡：

![](assets/a3aed45d-5004-4444-9c41-eb2422bcfd69.png)
...
![](assets/1ea708aa-da3a-46bc-bc0a-f3c48282b7a3.png)
...
![](assets/117bea65-4233-4043-8e34-07bd45a36ff0.png)
...
![](assets/c2de59cc-24f9-4be7-a29a-2fb8d96105ac.png)
...
![](assets/bbee9ede-d876-45f7-8608-f1b1292e5378.png)

6.  打开浏览器并转到`http://localhost:5000`。如果一切正常，你应该看到一个你好的世界！第页：

![](assets/b9f1d7eb-2745-4231-a105-1594342bf13f.png)
...
![](assets/e2678ee0-909c-4814-bc09-4e5185b02097.png)
...
![](assets/e702c87c-505c-4911-9940-4e7012469506.png)
...
![](assets/c21396cf-4b7d-4784-ba6a-3e659618ccf4.png)
...
![](assets/0a320c88-64ba-46fa-a261-0e2824d550a8.png)
...
![](assets/c3a521ad-6df2-463f-a6ff-61c973dd6994.png)
...
![](assets/64c76ba7-c384-44d2-b373-914c11774400.png)
...
![](assets/4882311a-9514-49ca-b60f-13f7c03a04db.png)
...
![](assets/dac68613-c178-43d2-bc5f-d1d08a67975c.png)
...
![](assets/c5fe2dc2-296e-4b85-96e1-9f624a13bf57.png)

5.  通过执行`dotnet run`运行示例应用程序：

![](assets/954d5fe6-15ae-4e8e-8ee2-d7e0b6f0523c.png)
...
![](assets/4539417e-b3db-4bbf-b61d-ab25b40d8bae.png)
