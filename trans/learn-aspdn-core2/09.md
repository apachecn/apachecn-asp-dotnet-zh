...
11.  启动应用程序，单击顶部菜单中的 Login 元素，并以现有用户的身份登录(或注册为用户，如果你之前没有这样做):
...
现在您已经了解了如何向应用程序添加身份验证，您必须考虑如何帮助用户重置他们忘记的密码。 用户会忘记他们的密码，这是可能发生的，所以您需要一些适当的机制。
