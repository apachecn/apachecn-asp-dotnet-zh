...
让我们在应用程序中创建一个`Models`文件夹；此文件夹将包含所有模型文件。在实际应用程序中，此文件夹和相应的模型文件将位于不同的项目中。为了简单起见，我们将`Models`文件夹及其文件保存在同一个项目中。
...
![](assets/b97fa05d-187f-461f-8a50-06b00be19c1b.png)
...
![](assets/6a4cc7bb-39d8-438f-a4b1-ba4e3e893ee8.png)
...
![](assets/ebaa4984-87c8-4be0-b610-eb27f0ab0f9e.png)
...
![](assets/e4dd875b-3e38-4dfa-a7c1-7de21ba1fa28.png)
...
![](assets/793367d5-1bf1-4a25-a9e4-f7103f7198d7.png)
...
![](assets/3f03c6e9-a952-49f5-baf3-fdab4938614a.png)

2.  在 NuGet 包中搜索`Microsoft.EntityFrameworkCore.SqlServer`。选择 Microsoft.EntityFrameworkCore.SqlServer 后，单击安装：

![](assets/9677e7fc-fe50-46f5-986c-6259cea0c922.png)

3.  单击 Install 后，NuGet 软件包管理器将要求您查看更改。单击“确定”：

![](assets/5723e937-287f-41ff-b1e9-3ba70f5a8adc.png)

4.  在许可证接受窗口中单击我接受：

![](assets/e838723c-d5cb-4085-8f69-c7f3c3f7cecb.png)
...
![](assets/5d3f2cea-806d-4d8c-a3ae-7b85ea96b34b.png)
...
![](assets/cf07e516-f45f-4959-a021-f79f63f93032.png)

以下是查询数据的屏幕截图：

![](assets/fa34052d-cb17-44ea-b9cf-18e4662491b5.png)
...
![](assets/313920e3-6796-48e9-9d27-8fc45b3edb6e.png)
...
![](assets/a050c68b-5181-4e6c-a665-aaa56df48f54.png)
...
![](assets/f71e7c19-5b13-4ea0-92eb-ee2feab9b0fb.png)
...
![](assets/063ff569-9120-433d-8289-b2cefef63354.png)
...
![](assets/c745cdc1-1fad-428c-ba9c-1a33794da630.png)

此命令将读取在上一步中创建的迁移文件，并创建数据库以及相关表：

![](assets/9b18cd3d-53f2-4af8-9c10-30646879a987.png)

以下屏幕截图显示了创建的数据库：

![](assets/fd51712f-0952-4dc8-9a84-45e636d94646.png)
...
![](assets/5a284326-d3e1-4684-b15e-5cf338375db2.png)

当您在表单中输入信息并提交时，信息将保存在数据库中，`Employees`表中的所有数据库记录将显示如下：

![](assets/cdd09cca-bccc-4883-a1f3-70bf72d79110.png)
