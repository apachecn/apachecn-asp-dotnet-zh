...
![](assets/f8ae3679-b397-4e72-b8f5-42083e4ad022.png)

# 产品详情

“产品详细信息”页面的外观可能与以下屏幕截图中显示的类似：

![](assets/2e261a6b-ae13-4e2f-9c7c-0d966a408a0e.png)

# 结账

“签出”页面的外观可能类似于以下屏幕截图中显示的内容：

![](assets/716c2043-588b-4bcc-838f-f5c3851df54b.png)

# 结帐成功

“Checkout Successful”（签出成功）页面的外观可能类似于以下屏幕截图所示：

![](assets/48b058fd-0602-4722-99a3-921998424abd.png)

# 以前的订单

上一个订单页面的外观可能类似于以下屏幕截图中显示的内容：

![](assets/1a89ab90-c80e-4c6d-9c03-208a99b86a22.png)
...
![](assets/9aca57e9-9e4d-44da-a7ca-13b2eb83c200.png)
...
![](assets/af81240e-45f6-4092-827f-f6539d7f8db8.png)

2.  选择 MVC 选项并单击 OK：

![](assets/4b3fcfb4-aa0c-4937-8333-7b259295af0b.png)

您将看到：

![](assets/db73d236-31ce-44e1-8531-6759328b55f4.png)

3.  将新项目添加为名为`RestBuy`的.NET 标准类库：

![](assets/38401f6d-60bd-4b11-9bee-fcb3ac01454c.png)

4.  将另一个项目添加为名为`RestBuy.InfraStructure`的.NET 标准类库：

![](assets/5976f1ef-6f4a-47c0-8ada-548e0bf8f78e.png)

5.  右键单击`RestBuy.Web`项目解决方案资源管理器中的依赖项部分，并将依赖项添加到其他项目：

![](assets/19699199-1db6-4b92-889b-6fff71454883.png)
...
![](assets/8c9a7d8b-9c40-44cf-87ed-77adeb819c66.png)
...
![](assets/4cd1aa7d-6ae6-4d65-b958-0ffdbace5250.png)
...
![](assets/ba9d96a7-b19f-42c9-8745-789af437ac62.png)
...
![](assets/6ce292b5-431b-4ce9-9a2d-ff97e27903e9.png)

3.  同样，安装`Microsot.EntityFrameworkCore.Tools`包，如下所示：

![](assets/d4115bd1-dc65-4cb8-8c20-ee941afddcf1.png)

因此，您的`Infrastructure`项目文件夹如下所示：

![](assets/3d31103e-18c8-4493-a327-a14b07ae9f38.png)
...
![](assets/8092b42a-193a-48c6-b87a-dc2af935b372.png)
...
![](assets/858223f0-ecda-4645-82bd-40f465aedd1a.png)

以下内容将显示在您的屏幕上：

![](assets/b52f4fdb-1351-487c-afdf-c2166e0d3e4c.png)

4.  然后，确保在 package manager 控制台中选择我们的基础设施项目类型`Add-MigrationInitialMigration`。运行此命令将在我们的`Infrastructure`项目中生成迁移：

![](assets/81e37595-154b-42f5-9fb6-7228966be562.png)

5.  接下来，我们使用`Update-Database`命令创建数据库：

![](assets/1d996641-8cf2-461b-ad49-54d2de447a78.png)

然后，我们可以看到我们的表是从 SQL Server 对象资源管理器创建的：

![](assets/33a8dcaa-b707-4924-b47e-29fd980533d2.png)
