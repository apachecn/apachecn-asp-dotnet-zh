...
![](assets/e41adf4a-2cd7-448e-b2e6-2e2c47675b9c.png)
...
![](assets/2884e61c-1806-400b-840e-1e1a32e14ad9.png)
...
![](assets/a886d028-4579-4cb2-9631-d3d87c6a2be4.png)

2.  我们将看到安装了一个名为 Microsoft.ASPNetCore.All 的包（如下面的屏幕截图所示）。这个包实际上是一个元包，它安装了我们需要的大多数依赖项。

![](assets/b9c5768a-847b-4513-8ee5-b28e0bf1412c.png)

3.  如果我们从依赖项扩展此包，我们将看到：

![](assets/cd44d5d6-6855-4964-8ae8-d94c235adc8e.png)
...
![](assets/e8f33649-c644-4457-a1a8-8e85e83273e3.png)
...
![](assets/8902b1c3-f843-47ab-b221-491175f2aa11.png)

![](assets/35b13530-bb3f-481c-adc1-fa048a97bc19.png)
...
![](assets/a10df822-35a1-425f-b48c-fc8da4732d3e.png)
...
![](assets/b45a9d7a-e56f-4f96-8a38-a76fd8d211bc.png)
...
![](assets/6470fafe-ecc7-4132-8a6c-faceb52cadf1.png)
...
![](assets/82a8d3d5-d45d-4349-8339-54d3a9f269d5.png)
...
![](assets/5dbd8ac5-d594-4209-888f-18d803db716a.png)

单击上一屏幕中的添加按钮时，将创建一个名为`Index2.cshtml`的文件，其中包含以下内容：

![](assets/ce884b4f-e4ee-4b76-b4fb-4eed7cbc9855.png)
...
![](assets/714c2292-4cb1-428a-befa-485f85411484.png)

下图说明了请求流以及我们如何通过视图生成响应：

![](assets/fa34f220-3f70-4847-945f-025498cd99b5.png)
...
![](assets/5cadb434-6721-4e43-b956-c183c654a1d2.png)
...
![](assets/d4b39bf8-208d-487f-b573-1f3dac2c08f1.png)
...
![](assets/4b4f0248-1256-4c1f-9f89-d673956a8000.png)
