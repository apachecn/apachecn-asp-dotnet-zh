...
[第二章](02.html "Chapter 2.  Building Your First ASP.NET Core Application")， *asp.NET Core应用*，展示了如何创建一个新的 asp.NET Core应用.NET Core web 应用。 本章将剖析现代 ASP 的各个部分.NET web 应用，同时解释什么是新的和什么改变了。
