...
![SimpleMembership](graphics/7362EN_09_01.jpg)

如果您现在展开`App_Data`文件夹，您应该会看到实际上有两个数据库，一个用于 BrewHow 上下文，另一个保存成员模式:

![SimpleMembership](graphics/7362EN_09_02.jpg)

双击会员数据库，在**数据库浏览器**中打开。

![SimpleMembership](graphics/7362EN_09_03.jpg)
...
![AccountController contexts](graphics/7362EN_09_04.jpg)

双击**酿酒**数据库，打开**数据库浏览器**。如果您展开**表**节点，您将看到我们的应用程序在单个数据库中运行所需的所有表:

![AccountController contexts](graphics/7362EN_09_05.jpg)

## 注册并登录

现在成员表已经配置好了，我们应该可以注册一个账户并登录了。首先启动应用程序，点击页面顶部的**注册**链接:

![Registering and logging in](graphics/7362EN_09_06.jpg)

在注册页面上，输入要创建的用户的凭据。完成后，点击**注册**按钮:

![Registering and logging in](graphics/7362EN_09_07.jpg)

点击 **注册**按钮后，您将自动登录到该应用程序，并获得新用户名:

![Registering and logging in](graphics/7362EN_09_08.jpg)
...
![Registering and logging in](graphics/7362EN_09_09.jpg)
...
![Registering with an external account](graphics/7362EN_09_10.jpg)

点击标签为**谷歌**的按钮，我们将进入谷歌**登录**页面:

![Registering with an external account](graphics/7362EN_09_11.jpg)

在输入我们的帐户信息后，谷歌以典型的 OAuth 方式要求我们授予 BrewHow 应用程序某些权限。在这种情况下，它要求向酿酒公司提供我们的电子邮件地址:

![Registering with an external account](graphics/7362EN_09_12.jpg)

点击**接受**将带我们回到我们的应用程序，在那里我们被要求提供用户名。我们链接帐户的默认用户名是我们的谷歌帐户地址:

![Registering with an external account](graphics/7362EN_09_13.jpg)

接受默认值并点击**注册**按钮，我们将使用谷歌帐户登录到 BrewHow。

![Registering with an external account](graphics/7362EN_09_14.jpg)
...
![Associating an external account](graphics/7362EN_09_15.jpg)
...
![Cleaning the UI](graphics/7362EN_09_16.jpg)

我们可以通过登录并返回到我们的`Index`视图来验证代码是否有效:

![Cleaning the UI](graphics/7362EN_09_17.jpg)
...
![Applying the ownership migration](graphics/7362EN_09_18.jpg)
...
![The library view](graphics/7362EN_09_19.jpg)
