...
代码优先的方法还允许我们使用迁移以(基本上)非破坏性的方式更新模式。这很重要，因为我们将调整模型，以更好地映射我们的领域，因为我们不断增强我们的应用程序。另外，它很酷，我们喜欢新的闪亮的玩具，对吗？因此，让我们启用 EF5，并开始在我们的应用程序中使用它。
...
![Generating our database](graphics/7362EN_04_02.jpg)

当然，没什么好看的。我们的表格标题在那里，但没有太多其他的。我们真正做的是创建数据库——一个空的数据库，但仍然是一个数据库。

要查看我们的数据库和其中的表格，请单击**解决方案资源管理器**工具栏上的**查看所有文件**图标。

![Generating our database](graphics/7362EN_04_03.jpg)

展开`App_Data`文件夹，双击名为`BrewHow.Models.BrewHowContext.mdf`的文件。

![Generating our database](graphics/7362EN_04_04.jpg)

我们新的数据库现在在**数据库浏览器**窗口中打开。

![Generating our database](graphics/7362EN_04_05.jpg)
...
![Overriding conventions](graphics/7362EN_04_06.jpg)
...
![Enabling migrations](graphics/7362EN_04_01.jpg)

在控制台中，输入`Enable-Migrations –ContextTypeName BrewHow.Models.BrewHowContext`并点击*进入*。

![Enabling migrations](graphics/7362EN_04_07.jpg)
...
![Enabling migrations](graphics/7362EN_04_08.jpg)
...
![Adding a migration](graphics/7362EN_04_09.jpg)
...
![Applying migrations](graphics/7362EN_04_10.jpg)
...
![Applying migrations](graphics/7362EN_04_11.jpg)
...
![Applying migrations](graphics/7362EN_04_12.jpg)

我们的样本数据确实在那里。

![Applying migrations](graphics/7362EN_04_13.jpg)
...
![Consuming the model](graphics/7362EN_04_14.jpg)
...
![Pagination](graphics/7362EN_04_15.jpg)
