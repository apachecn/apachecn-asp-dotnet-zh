...
![Table 2.1  ](Images/B15729_02_Table_1.jpg)

表 2.1

*   **编程语言**:。NET 支持多种编程语言。用一种语言编写的代码可以被其他语言访问。下表显示了支持的语言:

![Table 2.2 ](Images/B15729_02_Table_2.jpg)
...
![Figure 2.1 – Visualization of the .NET SDK ](Images/Figure_2.1_B15927.jpg)
...
2.  In the installation options, from **Workloads**, select **.NET Core cross-platform development** for .NET Core applications, as shown in the following screenshot:
    ...
    ![Figure 2.2 – Visual Studio installation, workload selection ](Images/Figure_2.2_B15927.jpg)
...
2.  From Command Prompt, run the `dotnet --version` command to verify the installed version, as shown in the following screenshot:
    ...
    ![Figure 2.3 – Command-line output of the dotnet command ](Images/Figure_2.3_B15927.jpg)
...
3.  Optionally, you can download and install Visual Studio Code from [https://code.visualstudio.com](https://code.visualstudio.com) to use it to develop the .NET application.
    ...
    ![Table 2.3 ](Images/B15729_02_Table_3.jpg)
...
5.  This command will create a new project called `HelloWorld` based on the `console` application template. Refer to the following screenshot:
    ...
    ![Figure 2.4 – Command-line output of the new console application ](Images/Figure_2.4_B15927.jpg)
...
![Figure 2.5 – Command-line output of the console application when run ](Images/Figure_2.5_B15927.jpg)
...
![Figure 2.6 – .NET Standard 2.0-supported .NET implementations ](Images/Figure_2.6_B15927.jpg)
...
![Figure 2.7 – Build artifacts targeting multiple frameworks ](Images/Figure_2.7_B15927.jpg)
...
![Table 2.4 ](Images/B15729_02_Table_4.jpg)
