...
**   在终端中键入以下命令以构建并运行示例应用程序：
    ...
    *   Once authenticated, you will be redirected to the **Loans** page:
    ...
    ![Figure 8.1 – Loans page](image/B17201_08_01.jpg)
    ...
    *   Type `Packt` as the keyword to search in the textbox on top of the empty table and hit the **Filter** button. Notice that the search term is displayed as a message:
    ...
    ![Figure 8.2 – Keyword search](image/B17201_08_02.jpg)

    图 8.2–关键字搜索

    *   为了测试我们的示例网银解决方案是否易受 XSS 攻击，我们在搜索栏中输入 XSS有效负载`<script>alert("Pwned")</script>`，然后点击**过滤器**按钮。检查此测试的结果：*

 *![Figure 8.3 – Reflected XSS](image/B17201_08_03.jpg)
...
![Figure 8.4 – Reflected XSS mitigated](image/B17201_08_04.jpg)
 ...
 *![Figure 8.5 – Stored XSS ](image/B17201_08_05.jpg)
...
![Figure 8.6 – Mitigated stored XSS vulnerability](image/B17201_08_06.jpg)
...
我们的示例网上银行web 应用程序在`Models\SeedData.cs`处植入了贷款数据。我们使用一个贷款申请填充 SQLite 数据库：
...
**   在终端中键入以下命令以构建并运行示例应用程序：
    ...
    *   Once authenticated, you will be redirected to the **Loans** page:
    ...
    ![Figure 8.7 – Loans page ](image/B17201_08_07.jpg)
 ...
 **![Figure 8.10 – DOM XSS fixed](image/B17201_08_10.jpg)
