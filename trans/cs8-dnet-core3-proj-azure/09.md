...
![](assets/ccb28bcf-c5d9-47a5-98f4-50a2758ddc2f.png)
...
在我们开始编写任何代码之前，我们需要配置我们的认知服务。为此，您需要一个 Azure 帐户；如果你还没有的话，请参考第二章(任务 Bug 记录 ASP.NET 核心 MVC 应用使用 Cosmos DB)。

让我们设置认知服务:

1.  我们将从导航到 Azure 门户中的认知服务刀片开始；您可以搜索它或从左侧的菜单中选择它。从此刀片添加新服务。一旦您这样做了，您将看到一个可能创建的认知服务列表:

![](assets/15f5bc30-9b9c-40cc-af40-d68607dbeae0.png)

2.  同样，您可以通过向下滚动面部应用编程接口或简单地在搜索框中键入`Face`来搜索该列表。这应该会打开面部应用编程接口，并允许您创建它:

![](assets/4c22ca5c-3f79-4449-92ec-74cfc7157b7e.png)

3.  选择“创建”后，您将看到一个熟悉的选项列表:

![](assets/f50473a1-755c-4fe8-a2a0-96704c6a8b69.png)

除非您打算将其用于商业目的(例如，高吞吐量)，否则我建议您选择 F0 的定价计划，本质上是免费的。

4.  创建资源后，您需要两条信息。第一个是访问密钥:

![](assets/d532ab0f-d27a-4347-b364-7d14c3db5578.png)

5.  您需要的第二条信息是端点，可以在概述屏幕上找到:

![](assets/b4d2b7a9-1195-485c-b7dd-fd5cdaf7e88c.png)
...
![](assets/73ca16d3-a38a-4ffc-8172-d6f361a004e6.png)

一旦您选择了一个 Xamarin 应用程序，您将看到一个进一步的对话框:

![](assets/2ce52699-3117-483f-bde4-d2d9cb7373ee.png)
...
![](assets/b185abb1-8f6c-41f5-9599-9b165772aa99.png)
...
![](assets/33087431-cd94-4f0f-8551-7348fc814adf.png)
...
![](assets/b5c83781-80b6-44fa-9dd6-a2dc4687b58b.png)
...
![](assets/27005399-6c12-4e79-a97f-d4edbe723050.png)
...
![](assets/2cd8576e-ad84-4b2c-a5ce-69c0df6eb9a4.png)

2.  在系统内部，您应该会看到一个标签为“关于电话”或类似的菜单选项:

![](assets/5eb06341-a056-43bf-a56e-58ca75faccf6.png)

3.  找到内部版本号:

![](assets/0bd7c89b-228c-490e-82ea-df592084162e.png)

4.  你需要敲这个七次。你会收到以下信息(不要眨眼，否则你会错过的！):

![](assets/fc9b4c7b-b00b-431a-afe7-93b4e3b1eb66.png)

5.  系统菜单上将出现一个新菜单，即开发人员选项:

![](assets/2c06c562-5390-4c84-84fc-bccf72a06c99.png)

6.  这个新菜单允许您确定测试软件时有用的各种设置；但是，有一个设置特别需要更改，那就是 USB 调试:

![](assets/b6f54585-8153-4e2c-93a6-faeb90fdac5b.png)

其他设置是可选的。你可能会发现保持清醒可以让你保持清醒，但是如果你在使用电话，不要忘记在之后关掉它。

下一步是检查 Android SDK 管理器。您应该(至少)为奥利奥(8.1)安装以下组件:

![](assets/97424e9b-6a92-426b-b169-728ff041fe36.png)
...
![](assets/bc08038d-0666-4494-9030-2db1517d1b2c.png)
