...
![](assets/18521c41-3435-4258-b98c-0416ed8aa25c.png)
...
![](assets/f07dfd30-c833-4ccb-8b2d-0e46006133b1.png)
...
![](assets/db6ad7ef-907f-4c09-a875-3c2abc6d12b4.png)

By default, the bot name will be set to the project name.

一旦你创建了你的机器人，运行它，你会看到下面的屏幕:

![](assets/2bad8bef-f7d9-41ca-a1dd-143fe9888572.png)
...
![](assets/85367152-08e2-45ae-91bb-c54fd58e28c0.png)
...
![](assets/45d2de4b-2e04-4218-a2f6-79ebf0e15c51.png)

一旦你连接了，你就能和你的机器人交谈了。让我们快速看一下模拟器屏幕:

![](assets/3a25b0a2-6fd5-4956-b14a-89479d359160.png)
...
![](assets/82546783-5532-4a7a-957b-322c7663c9d7.png)
...
![](assets/a4a3f480-a839-4d36-8d75-86691073f6e0.png)
...
![](assets/3db67670-8efe-4263-937f-ecc0e84edc07.png)
...
![](assets/2ae01775-2950-483a-bd09-5a13a831faa3.png)
...
![](assets/b244aedc-65ef-42fa-9e79-723dbc98fc6e.png)
...
![](assets/f66e7d77-2380-4811-9f2a-e6e7dee73ad4.png)

4.  在同一页面的底部，如果向下滚动，您将找到端点:

![](assets/197ef5e2-778c-4259-af62-5af0e26dedda.png)
...
![](assets/35a7d9e4-550d-4491-bf4a-31438b7eda83.png)
...
![](assets/489f537a-28c6-4dce-9332-858d24c14ff2.png)
...
![](assets/b052952f-5315-4bc3-92db-756d0fdb2afe.png)
...
![](assets/f34f6f3f-17b0-47ac-a655-2eb8fb247e19.png)

保持默认设置不变，并选择“发布”。现在，您将被问及一系列关于如何以及在哪里部署您的应用程序的问题:

![](assets/529ce58e-f4aa-44c3-b04b-09783822d209.png)
...
![](assets/5fc39096-a909-4f8f-9e3c-0d1e4e144ee5.png)

在下一个屏幕中，选择机器人频道注册:

![](assets/35d3a05a-bf87-4bb1-ae89-a7ea630dd582.png)

一旦您选择了创建机器人的选项，您将看到一个类似于下面的屏幕。屏幕截图后面的列表中描述了页面的标记部分:

![](assets/ea979c11-bf43-4284-94ad-2f06cd1408db.png)
...
![](assets/36eb20c0-0e91-4ccd-bda4-22045f8cfcf1.png)

记下`MicrosoftAppId`。选择管理以显示证书&秘密刀片:

![](assets/019299c5-cf52-4150-be01-e85ae4f8a977.png)

在这里，我们可以创造一个新的秘密:

![](assets/c5eea49a-60e9-4167-a175-7d9a1c8bf619.png)
...
![](assets/299b9d6c-8d11-4290-b884-9e245c6f79cc.png)
...
![](assets/0cf7ea47-84d2-4b94-92ce-71b354455810.png)

初始应用程序由两个 XAML 文件创建:`App.xaml`和`MainPage.xaml`:

![](assets/cd80dc50-dc2b-44d3-ac32-a3797e36d979.png)
...
![](assets/d70f4aaa-75b1-4da0-8f53-5d50034c8251.png)
...
![](assets/46014bf6-05d7-47a7-b056-3ae952c72bef.png)

抛开奇怪扭曲的图形不谈，直达线频道就是地球仪；如果你点击它，你应该被要求命名网站:

![](assets/12f65856-e072-4c6e-adfa-1de44c6b9078.png)
...
![](assets/a14cd5e3-5033-4e0d-aab6-79781e3f0805.png)
...
![](assets/531c6f1d-a6d6-48e6-8ff1-98fb48247b38.png)
