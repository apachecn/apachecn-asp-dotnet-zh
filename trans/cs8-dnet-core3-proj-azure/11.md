...
![](assets/6b0d80af-abee-467c-a0ea-988a64ea18e0.png)
...
![](assets/0a1444ab-c3cf-4ea2-bb9f-eac44af44a39.png)

2.  在下一个屏幕中，选择您的项目名称和位置，就像您通常会做的那样:

![](assets/277fb5c8-9c6b-4b95-9e3f-43e04e6fc7bc.png)

3.  在下一个屏幕中，您应该会看到几个选项。在本例中，我们将创建一个客户端 Blazor 应用程序:

![](assets/10a4965b-5a54-4453-bf12-5fbc2c080a65.png)

4.  如果您现在选择创建，您将看到一个完整的 Blazor 工作示例。尝试运行这个:您应该会看到一个功能齐全的单页应用程序。如果你看过 React 模板，你应该对这个结构非常熟悉。
...
![](assets/8bd6f183-8235-4774-b57a-baa9a4711cd7.png)
...
![](assets/0ee1dacd-9126-41df-b394-84db42a00ddf.png)
...
![](assets/055fce88-bd50-48f2-971f-271bd0dcdd7f.png)
