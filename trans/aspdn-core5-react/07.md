...
![Figure 7.1 – How components interact with Redux to get and update a state ](image/Figure_7.01_B16379.jpg)
...
4.  Let's now move on to the `GotUnansweredQuestions` action:
    ...
    ![Figure 7.2 – Narrowed action type ](image/Figure_7.02_B16379.jpg)
...
12.  如果应用程序未运行，请在终端中键入`npm start`以启动它。应用程序将正常运行，未回答的问题将显示在主页上，就像我们添加 Redux 商店之前一样：

![Figure 7.3 – HomePage component connected to the Redux store ](image/Figure_7.03_B16379.jpg)
...
![Figure 7.4 – QuestionPage component connected to the Redux store ](image/Figure_7.04_B16379.jpg)
...
![Figure 7.5 – SearchPage component connected to the Redux store ](image/Figure_7.05_B16379.jpg)
