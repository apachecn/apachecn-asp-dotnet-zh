...
我们将创建一个 ASP.NET Core MVC Web 应用模板通过去文件|新|项目| AspNet 核心 Web 应用。
...
我们将创建一个 ASP.NET 核心 MVC web 应用模板文件|新|项目| AspNet 核心 web 应用。
...
我们将创建一个 ASP.NET 核心 MVC Web 应用模板通过去文件|新|项目| AspNet 核心 Web 应用。
...
我们将创建一个 ASP.NET Core MVC Web 应用模板文件|新|项目| AspNet 核心 Web 应用(。 Web 应用。
