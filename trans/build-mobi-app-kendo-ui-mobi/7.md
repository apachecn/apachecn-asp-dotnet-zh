...
![Movie list](graphics/0922OT_07_02.jpg)
...
![The Movie list screen](graphics/0922OS_07_01.jpg)

一旦我们完成这个视图，并将其与来自服务的数据连接起来，我们的应用程序将看起来像下面的截图:

![The Movie list screen](graphics/0922OT_07_3.jpg)
...
![Configuring view and ListView](graphics/0922OT_07_4.jpg)
...
![Movie list type ButtonGroup](graphics/0922OT_07_07.jpg)
...
![Adding ListView for theaters](graphics/0922OT_07_5.jpg)
...
![The Book Tickets view](graphics/0922OT_07_10.jpg)
...
![The Book Tickets view](graphics/0922OT_07_11.jpg)

# 创建预告片视频幻灯片屏幕

现在让我们创建应用程序的最终屏幕，它显示电影预告片的幻灯片，这些预告片是 YouTube 上托管的视频。为此，我们正在使用剑道用户界面移动滚动视图小部件。
...
![The JavaScript module](graphics/0922OT_07_13.jpg)
