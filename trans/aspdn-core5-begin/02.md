...
您拥有开发.NET 应用所需的.NET 5 SDK。这在macOS 上起作用的事实意味着开发人员不需要 Windows 计算机来开发 Windows 软件，而且由于 MacBook 在科技界很受欢迎，这就拓宽了.NET 的潜在开发受众。
...
Docker是当今的热门话题，将在[*第 9 章*](09.html#_idTextAnchor187)、*Docker*中详细介绍。然而，我们应该解释Docker和跨平台之间的关系。
