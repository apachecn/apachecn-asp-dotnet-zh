...
![Figure 3.1 – ASP.NET Core framework-provided services ](image/Figure_3.1_B16559.jpg)
...
![Figure 3.2 – Microsoft.AspNetCore.App NuGet package ](image/Figure_3.2_B16559.jpg)
...
![Figure 3.3 – The music list page ](image/Figure_3.3_B16559.jpg)
...
![Figure 3.4 – Tightly-coupled dependency ](image/Figure_3.4_B16559.jpg)
...
![Figure 3.5 – Loosely-coupled dependency ](image/Figure_3.5_B16559.jpg)
...
1.  Just simply right-click on the `MusicManager` class and select **Quick Actions and Refactorings...**, as shown:
    ...
    ![Figure 3.6 – The built-in Quick Actions and Refactorings feature ](image/Figure_3.6_B16559.jpg)

    图 3.6–内置的快速操作和重构功能

2.  Then, select **Extract interface…**:

    ![Figure 3.7 – The built-in Extract interface feature ](image/Figure_3.7_B16559.jpg)

    图 3.7–内置提取接口功能

3.  Now, you should be presented with a pop-up dialog to configure the interface, as shown in the following screenshot:

    ![Figure 3.8 – The Extract Interface pop-up window ](image/Figure_3.8_B16559.jpg)
...
![Figure 3.9 – Method injection ](image/Figure_3.9_B16559.jpg)
...
![Figure 3.10 – Property injection ](image/Figure_3.10_B16559.jpg)
...
![Figure 3.11 – View injection output ](image/Figure_3.11_B16559.jpg)
...
**依赖注入容器**并不是应用 DI 技术的真正要求。然而，随着应用程序的增长和变得更加复杂，使用它可以简化对所有依赖项的管理，包括它们的生命周期。
...
![Figure 3.12 – The DI container ](image/Figure_3.12_B16559.jpg)
...
![Figure 3.13 – The RequestId value from the IMusicManager interface instance ](image/Figure_3.13_B16559.jpg)
...
![Figure 3.14 – The RequestId value from the InstrumentalMusicManager class instance ](image/Figure_3.14_B16559.jpg)
...
![Figure 3.15 – The RequestId value from the IMusicManager interface instance ](image/Figure_3.15_B16559.jpg)
...
![Figure 3.16 – The RequestId value from the InstrumentalMusicManager interface instance ](image/Figure_3.16_B16559.jpg)
...
![Figure 3.17 – The RequestId value from the IMusicManager interface instance ](image/Figure_3.17_B16559.jpg)
...
![Figure 3.18 – The RequestId value from the InstrumentalMusicManager interface instance ](image/Figure_3.18_B16559.jpg)
...
学习和理解每个服务生命周期是如何工作的对于应用程序的正确运行非常重要。现在，让我们快速查看下一节中如何处理复杂场景的服务。
...
![Figure 3.19 – The HomeController class constructor injection ](image/Figure_3.19_B16559.jpg)
...
![Figure 3.20 – The HomeController class constructor injection ](image/Figure_3.20_B16559.jpg)
...
![Figure 3.21 – Resolving all instances of IMusicManager ](image/Figure_3.21_B16559.jpg)
