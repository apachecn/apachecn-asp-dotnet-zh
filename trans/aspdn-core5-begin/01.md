...
![Figure 1.1 – Verifying the installation of .NET  ](image/B16559_01_01.jpg)
...
![Figure 1.2 – The .NET platform ](image/B16559_01_02.jpg)
...
![Figure 1.3 – .NET supportability schedule ](image/B16559_01_03.jpg)
...
![Figure 1.4 – Running the default web app template ](image/B16559_01_04.jpg)
...
![Figure 1.5 – The file structure of the web app in Visual Studio 2019 ](image/B16559_01_05.jpg)

图 1.5–Visual Studio 2019 中 web 应用程序的文件结构
...
![Figure 1.6 – Hello World with the current time printed ](image/B16559_01_06.jpg)
...
![Figure 1.7 – Listing the available templates in .NET ](image/B16559_01_07.jpg)
...
![Figure 1.8 – Code improvement suggestions ](image/B16559_01_08.jpg)
...
Web 应用程序可以是有状态的，也可以是无状态的。如果它们是有状态的，这意味着在客户端和服务器之间有一种对话，其中下一段通信取决于先前的请求或响应。如果它们是无状态的，服务器将响应每个请求，就像这是双方第一次通信一样。（您可以在请求中嵌入 ID，以跨无状态会话维护状态。）
...
![Figure 1.9 – Fiddler HTTPS capture settings](image/B16559_01_09.jpg)
...
![Figure 1.10 – Fiddler HTTP request constructor ](image/B16559_01_10.jpg)

图 1.10–Fiddler HTTP 请求构造函数

如果这是一个错误，您可以通过单击网站来复制自己，VisualStudio 就是您的朋友。您有**输出**窗口，该窗口将提供过程级信息：

![Figure 1.11 – Visual Studio output window](image/B16559_01_11.jpg)
...
![Figure 1.12 – Output of dotnet run ](image/B16559_01_12.jpg)
...
![Figure 1.13 – Visual Studio Code navigation menu ](image/B16559_01_13.jpg)
...
![Figure 1.14 – Visual Studio accounts ](image/B16559_01_14.jpg)

图 1.14–Visual Studio 帐户

在中至右下方窗格中，您可以启用一些控制台窗口：

![Figure 1.15 – Visual Studio output tabs ](image/B16559_01_15.jpg)
...
![Figure 1.16 – C# Extension for Visual Studio Code ](image/B16559_01_16.jpg)
...
![Figure 1.17 – Windows Terminal ](image/B16559_01_17.jpg)
...
![Figure 1.18 – Windows Terminal with Git support enabled ](image/B16559_01_18.jpg)
