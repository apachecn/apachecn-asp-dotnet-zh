...
![Figure 11.1 – dotnet - -info ](image/ch11.01.jpg)
...
![Figure 11.2 – Counter page ](image/ch11.02.jpg)
...
![Figure 11.3 – Counter.razor ](image/ch11.03.jpg)
...
![](image/B16559_Ch_11_Table_1.jpg)
...
1.  The first step is to add a JavaScript file named `storageHandling.js` in the `wwwroot` folder. *Figure 11.4* screenshot shows the location of the file:
    ...
    ![Figure 11.4 – storageHandling.js ](image/ch11.04.jpg)
