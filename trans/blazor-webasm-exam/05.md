...
![Figure 5.1 – Service worker life cycle ](Images/Figure_5.1_B16786.jpg)
...
![Figure 5.2 – Service worker waiting to activate ](Images/Figure_5.2_B16786.jpg)
...
![Figure 5.3 – Types of service workers ](Images/Figure_5.3_B16786.jpg)
...
3.  In the **Search for templates** (*Alt* + *S*) textbox, enter `blazor` and hit the *Enter* key.
    ...
    ![Figure 5.5 – Empty Blazor WebAssembly App project template ](Images/Figure_5.5_B16786.jpg)
...
![Figure 5.6 – Configure your new project dialog ](Images/Figure_5.6_B16786.jpg)
...
10.  From the **Debug** menu, select the **Start Without Debugging** (*Ctrl* + *F5*) option to run the project.
    ...
    ![Figure 5.7 – Geolocation permission dialog ](Images/Figure_5.7_B16786.jpg)
...
![Figure 5.8 – Home page displaying coordinates ](Images/Figure_5.8_B16786.jpg)

图 5.8–显示坐标的主页

您可以使用**允许的**位置访问对话框禁用应用程序访问您的位置的功能，如下图所示:

![Figure 5.9 – Location access allowed dialog ](Images/Figure_5.9_B16786.jpg)
...
4.  Select the **Manifest** option from the menu on the left to view the **App Manifest**.
    ...
    ![Figure 5.10 – App Manifest details ](Images/Figure_5.10_B16786.jpg)
...
5.  Select the **Service Workers** option from the menu on the left to view the service worker that is installed for the current client, as illustrated in the following screenshot:
    ...
    ![Figure 5.11 – Service Workers dialog ](Images/Figure_5.11_B16786.jpg)
...
7.  Click on the `offline1` cache to view its contents, as illustrated in the following screenshot:
    ...
    ![Figure 5.12 – Cache Storage option ](Images/Figure_5.12_B16786.jpg)
...
10.  Refresh the browser, and you should see the following screen:
    ...
    ![Figure 5.13 – Offline page ](Images/Figure_5.13_B16786.jpg)
...
1.  Select the **Install 5-Day Weather Forecast** menu option from the browser's menu:
    ...
    ![Figure 5.14 – Install 5-Day Weather Forecast option ](Images/Figure_5.14_B16786.jpg)
...
2.  Click the **Install** button on the dialog:
    ...
    ![Figure 5.15 – Install PWA dialog ](Images/Figure_5.15_B16786.jpg)

    图 5.15–安装 PWA 对话框

    安装后，PWA 会出现，但没有地址栏。它出现在我们的任务栏上，我们可以从**开始**菜单运行它。以下截图显示了安装后的 PWA:

    ![Figure 5.16 – Installed PWA ](Images/Figure_5.16_B16786.jpg)
...
4.  Click the *Windows* key and open the **5-Day Weather Forecast** app:
    ...
    ![Figure 5.17 – The PWA on the Start menu ](Images/Figure_5.17_B16786.jpg)
...
1.  Select the **Customize and control 5-Day Weather Forecast** option from the PWA's menu:
    ...
    ![Figure 5.18 – Customize and control 5-Day Weather Forecast option ](Images/Figure_5.18_B16786.jpg)

    图 5.18–定制和控制 5 天天气预报选项

2.  Select the **Uninstall 5-Day Weather Forecast…** option:

    ![Figure 5.19 – Customize and control PWA dialog ](Images/Figure_5.19_B16786.jpg)

    图 5.19–定制和控制 PWA 对话框

3.  点击**移除**按钮:

![Figure 5.20 – Remove PWA dialog ](Images/Figure_5.20_B16786.jpg)
