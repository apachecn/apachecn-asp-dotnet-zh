# *第 4 章*:使用 JavaScript 互操作性(JS Interop)构建本地存储服务
...
从调用一个 JavaScript 函数。NET，我们使用`IJSRuntime`抽象。这个抽象表示框架可以调用的 JavaScript 运行时的一个实例。要使用`IJSRuntime`，我们必须首先使用依赖注入将其注入到我们的组件中。有关依赖注入的更多信息，请参考 [*第 6 章*](06.html#_idTextAnchor162) *【使用应用程序状态构建购物车】*。
...
![Figure 4.1 – Updated document title ](Images/Figure_4.1_B16786.jpg)
...
![Figure 4.2 – Window size example ](Images/Figure_4.2_B16786.jpg)
...
![Figure 4.3 – Local Storage ](Images/Figure_4.3_B16786.jpg)
...
![Figure 4.4 – Local Storage Service test page ](Images/Figure_4.4_B16786.jpg)
...
3.  In the **Search for templates (***Alt***+***S***)** textbox, enter `Blazor` and hit the *Enter* key.
    ...
    ![Figure 4.5 – Empty Blazor WebAssembly App project template ](Images/Figure_4.5_B16786.jpg)
...
![Figure 4.6 – Configure your new project dialog ](Images/Figure_4.6_B16786.jpg)
...
3.  Add the following code to the code block:
    ...
    ![Figure 4.7 – Local Storage Service test page ](Images/Figure_4.7_B16786.jpg)
...
![Figure 4.8 – Local storage ](Images/Figure_4.8_B16786.jpg)
