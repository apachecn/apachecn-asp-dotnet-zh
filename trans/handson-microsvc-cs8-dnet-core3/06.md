...
**JSON 网络代币** ( **JWT** )发音为 *JOT* 。这是一个定义良好的 JSON 模式或格式，用于描述数据交换过程中涉及的令牌。JSON 网络令牌在[https://tools.ietf.org/html/rfc7519](https://tools.ietf.org/html/rfc7519)详细定义。JWTs 可以用来验证请求，而不需要使用 OpenID 和 OAuth2.0。NET Core应用。
