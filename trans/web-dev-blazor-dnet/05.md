...
3.  Replace the content with the following code in the `Alert.razor` file:
    ...
    ![Figure 5.1 – The default look of a Bootstrap alert component ](image/Figure_5.1_B16009.jpg)
...
![Figure 5.2 – Screenshot of the test page](image/Figure_5.2_B16009.jpg)
...
![Figure 5.3 – Blog post screenshot ](image/Figure_5.3_B16009.jpg)
