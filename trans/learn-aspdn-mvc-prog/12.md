...
*   身份验证和授权
*   ASP。 净的身份
*   如何在 ASP 中实现安全性。 asp.NET Core应用使用.NET 身份与实体框架
...
在本章中，我们学习了身份验证和授权。 我们还学习了如何实现 ASP。 asp.net 标识.NET Core应用，遵循一个循序渐进的过程。 我们还讨论了 ASP 中涉及到的表.NET 身份，并学习了如何查看由 asp.net 创建的数据。 净的身份。